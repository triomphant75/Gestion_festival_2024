<?php
session_start();
include_once '../function/VoeuxFunction.php';
?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php
                              $voeux = getVoeux();
                              if (!empty($voeux)&& is_array($voeux)){
                                foreach ($voeux as $key => $value){    
                                  ?>
                                  <tr>
                                    <td><?=$value['idvoeux']?></td>
                                    <td><?=$value['idetablissement']?></td>
                                    <td><?=$value['idreferent']?></td>
                                    <td><?=$value['dateenvoie']?></td>
                                    <td><?=$value['prioritevoeux']?></td>
                                
                                    <td><a href ="?idvoeux=<? $value['idvoeux'] ?>"><ion-icon name="create"></ion-icon></<a></td>
                                  </tr>
                                  <?php
                                }
                              }
