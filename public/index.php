  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <a class="navbar-brand brand-logo" href="#"><img class="imageLogo" src="../assets/images/Logo Festi.png" alt="logo" style="width: 65px; height: auto;" /></a>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../views/AjoutEdition.php">créer une edition</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../views/ListeEditions.php">Liste des editions</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../views/InscriptionsEdition.php">s'inscrire</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="auth4">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../views/LancementVoeux.php">Lancement des voeux</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../views/ListeDesVoeux.php">Liste voeux</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../views/AnalyseVoeux.php">Analyse des Voeux</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth2">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../views/AjoutIntervention.php">Ajouter une intervention</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../views/ListeIntervention.php"> Liste des interventions</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth3">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../views/AjoutOeuvre.php">Ajouter oeuvre</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../views/ListeOeuvre.php"> Liste des oeuvres</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../views/AjoutParticipant.php">Ajouter un participant</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../views/ListeParticipant.php"> Liste des participants</a></li>
