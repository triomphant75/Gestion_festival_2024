...
if (
    ...
    $sql = "INSERT INTO intervention (dureeintervention,datedebutintervention,datefinintervention, lieuintervention, etatintervention,idetablissement,idinterprete,idauteur,idaccompagnateur, idedition)
            VALUES(?,?,?,?,?,?,?,?,?,?)";
